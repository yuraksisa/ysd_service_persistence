module Persistence
  module Model
  	#
  	# It allows to declare the hooks in the resource definition using the methods:
  	#
  	# - before :save | :create | :update | :destroy
  	#
  	# - after :save | :create | :update | :destroy
  	#
    module ModelHook
      ...
      def self.included(model)
      	model.send(:include, Persistence::Hook) # This class will convert the declared hooks into methods
